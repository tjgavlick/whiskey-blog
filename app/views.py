...
@app.route('/admin/remove/drinktype/<int:drink_type_id>')
...
@app.route('/admin/save/origin/', methods=['POST'])
def save_origin():
    ...
    # if we're adding a new entry
        ...
        origin = Origin(request.form['name'])
...
@app.route('/admin/remove/origin/<int:origin_id>')
